...
def to_float_hours(hours, minutes, seconds):
    ...
    1.01
    """
    return round(hours + minutes/60 + seconds/3600, 8)
...
def get_hours(seconds_since_midnight):
    ...
    seconds_since_midnight is a number of seconds since midnight.
    Return the number of hours that have elapsed since midnight,
    as seen on a 24-hour clock. This means that the return value should
    be in the range 0 to 23, inclusive.
...
def get_minutes(seconds_since_midnight):
    ...
    parameter seconds_since_midnight is a number of seconds since midnight.
