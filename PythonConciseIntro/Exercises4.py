...
def temp_stat(temps):
    ...
    import statistics
    print("{0:<21}{1:>10.2f}".format("Mean:",statistics.mean(temps)))
    print("{0:<21}{1:>10.2f}".format("Median:",statistics.median(temps)))
    try:
        print("Mode:",statistics.mode(temps))
    except statistics.StatisticsError as e:
        print("{0:<21}{1:<10}".format("Mode Error:",str(e)))
    print("{0:<21}{1:>10.2f}".format("Standard Deviation:",statistics.stdev(temps)))
    print("{0:<21}{1:>10.2f}".format("Variance:",statistics.variance(temps)))
...
What if we want to run the block only if the program was used by itself and not 
when it was imported from another module? This can be achieved using the __name__ attribute 
of the module.
"""
#!/usr/bin/python
